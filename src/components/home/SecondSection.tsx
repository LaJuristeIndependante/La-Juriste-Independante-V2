    ...
    return (
        <div className={`${isMobile ? 'h-[80vh]' : 'h-[90vh]'} flex flex-col md:flex-row justify-evenly items-center mb-5`}>
            <div className='flex items-center justify-center w-full md:w-1/3 h-48 md:h-72'>
                {isMobile ? (
                    <div className="flex items-center flex-col justify-center h-[250px] w-48 mb-10" style={{
            ...
            <div className='flex flex-col items-center md:items-end w-full md:w-1/3'>
                ...
                <p className='text-center md:text-left text-lg w-1/2²    md:w-full mt-5 mx-4 md:mx-0 special-text'>
