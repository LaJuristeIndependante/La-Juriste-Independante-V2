...
import {sendContactForm} from "@lib/Contact/type/ContactType";
  ...
  return (
    <div className={`border-2 border-black max-w-[600px] flex flex-col items-start justify-center p-4 h-auto md:h-[500px] ${isMobile ? 'text-sm w-11/12' : 'text-base w-full'}`}>
      <form className="w-full">
        ...
        <button className='w-full bg-[#DD2A27] text-white focus:outline-none py-2 rounded-md hover:bg-[#FF4D4D] mb-4'>
          Envoyer
        </button>
      </form>
      {showPopup && (
