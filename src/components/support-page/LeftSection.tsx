    ...
    <div className={` bg-[#232222] flex flex-col text-white p-4 h-auto md:h-[490px] ${isMobile ? 'text-sm w-5/6 rounded-b-xl ' : 'text-base w-1/3 rounded-l-xl '}`}>
      <div className='ml-4'>
        ...
        <p className={`mt-1 w-11/12 ${isMobile ? 'text-xs' : 'text-base'}`}>
            <strong>Vous n’avez pas trouvé le modèle juridique qu’il vous faut ?</strong> <br/><br/>
            Pas de problème, nous sommes là pour vous aider ! Si aucun des modèles proposés ne correspond à vos besoins spécifiques, n’hésitez pas à nous contacter<br/><br/>
